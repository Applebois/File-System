...
void edit(int currentuserlevel,string usernames);
void displaylevel(int currentuserlevel);
bool verifyblacklist(string);


int level0(string username , string userdescription,string group)
{
int currentuserlevel=0;
char command;
string filename,string_fot,dump;
string console;
cout<<"Your menu"<<endl;
cout<<"You enjoying Write privilege ."<<endl;
filename = "\home\\"+username+"\\";
menu:
cout<<"(C)reate, (W)rite, (L)ist , (S)wapAccount ";
